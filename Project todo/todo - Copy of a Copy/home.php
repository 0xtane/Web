		...
		<div class="cover2" onclick="hideShowUser(); removeFromPop()"></div>
			<nav>
				...
				<div class = "linput_box">	
					<input type="text" class="linput" id="addList" placeholder="Create List">
					<input type="button" onclick = "addList();" class="linput_btn" value="+">
				</div>

				<a id="menu" onclick="hideShowMenu()">|||</a>
				<div class="menu">
					<a class="menuItem username"><?php if(isset($_SESSION['username'])){echo "#".$_SESSION['username'];}else{echo "#".$_COOKIE['user'];}?></a>
