<?php
	...
	if(isset($_POST['true'])){
		$TID = $_POST['true'];
		$query = "UPDATE tasks set completed=true where TID='$TID'";
		$result = mysqli_query($con, $query);
	}

	if(isset($_POST['false'])){
		$TID = $_POST['false'];
		$query = "UPDATE tasks set completed=false where TID='$TID'";
		$result = mysqli_query($con, $query);
	}
	...
	if(isset($_POST['position']) && isset($_POST['LiID'])){
		$LiID = $_POST['LiID'];
	...
	if(isset($_POST['position']) && isset($_POST['TID'])){
		$TID = $_POST['TID'];
		$position = $_POST['position'];
